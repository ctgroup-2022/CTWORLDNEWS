...
function CTUniversity({ searchQuery }) {
  ...
  return (
    <div className={`min-h-screen ${theme === 'light' ? 'bg-gray-50 text-gray-900' : 'bg-gray-800 text-white'}`}>
      ...
      <h1 className={`text-3xl font-bold mb-6 pl-8 ${theme === 'light' ? 'text-[#195CA0]' : 'text-[#FBCC12]'}`}>CT UNIVERSITY</h1>
...
CTUniversity.propTypes = {
  searchQuery: PropTypes.string.isRequired,
};

export default CTUniversity;
